...
public class SendMessageServiceImpl implements SendMessageService{
    ...
    public String getResponseText(long chatId, String messageText) {
        ...
        if(result == null) result = """
                ...
                Например: подключить улица Генерала Черняховского, 51
                Для правильного введения адреса рекомендуется скопировать адрес(полное название улицы и номер дома) из сервиса https://yandex.ru/maps/50/perm\s
